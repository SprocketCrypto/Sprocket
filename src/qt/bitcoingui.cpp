                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sprocket Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sprocket address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sprocket: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sprocket Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sprocket Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sprocket"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sprocket addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sprocket addresses"));
    ...
    openAction->setStatusTip(tr("Open a Sprocket: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sprocket Core help message to get a list with possible Sprocket command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sprocket Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sprocket network", "", count));
}
...
{
    QString strTitle = tr("Sprocket Core"); // default title
