...
/** Utility functions used by the Sprocket Qt UI.
 */
namespace GUIUtil
{
...
// Render Sprocket addresses in monospace font
...
// Parse "sprocket:" URI into recipient object, return true on successful parsing
