...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Sprocket Core"),
     ...
     * override -datadir in the sprocket.conf file in the default data directory
     * (to be consistent with sprocketd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
