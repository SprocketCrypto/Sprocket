...
public:
	...
	nMinerThreads = 0;
	nTargetTimespan = 1 * 60; // Sprocket: 60s
	nTargetSpacing = 1 * 60; // Sprocket: 60s
	nLastPOWBlock = 518400; // Sprocket: 360 Days.
	...
	vSeeds.push_back(CDNSSeedData("sprkc.network", "sprocket.sprkc.network"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 112); // Sprocket pubkey address starts with 'n'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 8); // Sprocket P2SH address starts with '4'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 196); // Sprocket Private address starts with '2'
...
public:
	...
	vSeeds.push_back(CDNSSeedData("thesnoot.space", "sprockettestnet.thesnoot.space"));
	vSeeds.push_back(CDNSSeedData("sprkc.network", "sprockettestnet.sprkc.network"));
	...
	// Using Bitcoin defaults for Testnet
        ...
        // Testnet sprocket BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Sprocket: 1 day
        nTargetSpacing = 1 * 60;        // Sprocket: 1 minutes
