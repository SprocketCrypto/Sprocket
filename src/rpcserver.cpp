...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Sprocket server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Sprocket server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
	...
	{"util", "makekeypair", &makekeypair, true, false, false},
        ...
        /* Sprocket features */
        {"sprocket", "masternode", &masternode, true, true, false},
        {"sprocket", "listmasternodes", &listmasternodes, true, true, false},
        {"sprocket", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sprocket", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sprocket", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sprocket", "masternodedebug", &masternodedebug, true, true, false},
        {"sprocket", "startmasternode", &startmasternode, true, true, false},
        {"sprocket", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sprocket", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sprocket", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sprocket", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sprocket", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sprocket", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sprocket", "mnbudget", &mnbudget, true, true, false},
        {"sprocket", "preparebudget", &preparebudget, true, true, false},
        {"sprocket", "submitbudget", &submitbudget, true, true, false},
        {"sprocket", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sprocket", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sprocket", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sprocket", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sprocket", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sprocket", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sprocket", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sprocket", "checkbudgets", &checkbudgets, true, true, false},
        {"sprocket", "mnsync", &mnsync, true, true, false},
        {"sprocket", "spork", &spork, true, true, false},
        {"sprocket", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sprocket", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sprocketd, or the -server option to sprocket-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sprocket-cli " + methodname + " " + args + "\n";
}
