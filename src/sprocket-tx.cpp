...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sprocket Core sprocket-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sprocket-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sprocket transaction") + "\n" +
                               "  sprocket-tx [options] -create [commands]   " + _("Create hex-encoded sprocket transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sprocket transaction
