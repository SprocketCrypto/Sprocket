Contributing to Sprocket Core
============================

The Sprocket Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Sprocket Core project, and is not to be
confused with overall Sprocket Network Protocol consensus changes.

Whether a pull request is merged into Sprocket Core rests with the project merge
...
Patches that change Sprocket consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sprocket consensus, it must have been
...
The project leader is the release manager for each Sprocket Core release.
