...
In order to support loading of multiple wallets in sprocket-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sprocket.cpp.
...
Changes to sprocket.cpp
----------------------
sprocket.cpp is the entry point into sprocket-qt, and as such, will require some minor modifications to provide hooks for
