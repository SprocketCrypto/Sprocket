...
RESOURCES += src/qt/sprocket.qrc src/qt/sprocket_locale.qrc

TRANSLATIONS += src/qt/locale/sprocket_bg.ts \
                src/qt/locale/sprocket_de.ts \
                src/qt/locale/sprocket_en.ts \
                src/qt/locale/sprocket_es.ts \
                src/qt/locale/sprocket_fi.ts \
                src/qt/locale/sprocket_fr.ts \
                src/qt/locale/sprocket_it.ts \
                src/qt/locale/sprocket_ja.ts \
                src/qt/locale/sprocket_pl.ts \
                src/qt/locale/sprocket_pt.ts \
                src/qt/locale/sprocket_ru.ts \
                src/qt/locale/sprocket_sk.ts \
                src/qt/locale/sprocket_sv.ts \
                src/qt/locale/sprocket_vi.ts \
                src/qt/locale/sprocket_zh_CN.ts \
                src/qt/locale/sprocket_zh_TW.ts
